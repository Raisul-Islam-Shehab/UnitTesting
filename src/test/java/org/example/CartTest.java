...
class CartTest {
    ...
    static void init(){
        ...
        product3 = new Products("tshirt", "heavy-metal", 500);
    ...
    void addToCart() {
        ...
        assertEquals("pant", cart.cartItems.get(0).Name);
        assertEquals("freeland", cart.cartItems.get(0).Group);
    ...
    void viewCart() {
        ...
        assertEquals("freeland", cart2.cartItems.get(0).Group);
        assertEquals(1500, cart2.cartItems.get(0).Price);

        assertEquals("tshirt", cart2.cartItems.get(2).Name);
        assertEquals("heavy-metal", cart2.cartItems.get(2).Group);
